...
from riptide_msgs.action import Immerse
...
class Mission(Node):
    ...
    def send_immersion_goal(self):
        ...
        self._send_goal_future = self._action_client.send_goal_async(immerse_msg, feedback_callback=self.feedback_callback)
    ...
    def get_result_callback(self, future):
        ...
        if (result):
            self.get_logger().info(f'Total immersion duration {result.result.final_duration}s')
